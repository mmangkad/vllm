...
class WorkspaceManager:
    ...
    def reserve_for_all_ubatches(
        ...
        """Reserve simultaneous workspace capacity for every ubatch slot."""
        actual_bytes = [_compute_bytes(s, d) for s, d in shapes_and_dtypes]
    ...
    def _ensure_workspace_size(
        ...
        Args:
            ...
            ubatch_id: Workspace slot to resize. Defaults to the active ubatch.
        ...
        assert 0 <= ubatch_id < self._num_ubatches
